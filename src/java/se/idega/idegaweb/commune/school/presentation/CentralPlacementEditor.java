...
public class CentralPlacementEditor extends CommuneBlock {
  ...
  public Table getSearchTable(IWContext iwc) {
	...
	//	*** WINDOW HEADING ***
/*      table.add(getLocalizedSmallHeader(KEY_WINDOW_HEADING, "Central placing of pupil"), col, row);
      table.setColor(col, row, getHeaderColor());
...
*/
	...
	row++;
      ...
      table.add(getSearchUserModule(iwc), col++, row);
		//table.add(new SubmitButton(iwrb.getLocalizedImageButton(KEY_BUTTON_BACK, "Back"), 
			//																							PARAM_BACK, "true"), 2, row);
  ...
  public Table getPlacementTable(IWContext iwc) {
   ...
   // table.add(new HiddenInput(PARAM_ACTION, "-1"), 1, 1);
	//table.add(new HiddenInput(PARAM_PRESENTATION, String.valueOf("-1")), 1, 1);	
