 ...
 */
public class PlacementHistoryEditPlacement extends Window {
	...
	public PlacementHistoryEditPlacement() {
		this.setWidth(510);
		this.setHeight(450);
	...
	private void submitParentAndClose() {
		this.setParentPageFormToSubmitOnUnLoad(PlacementHistoryViewer.SEARCH_FORM_NAME);
		close();
	}
	...
	public void main(IWContext iwc) throws Exception {
		...
		if (iwc.isParameterSet(PARAM_CLOSE_AND_RELOAD)) {
			...
			setMainTableContent(new SchoolAdminOverview());
			add(mainTable);
		}
	}
